                            ...
                            @if($event->userimage)
                                <div class="form-group">
                                    <label for="accomodation">{{ trans('panel.eventUserImage') }}</label>
                                    <input type="text" class="form-control" id="userimage" name="userimage" value="{{ old('userimage') }}" placeholder="{{ trans('page.not_required') }}">
                            ...
                            <p class="section-paragraph text-justify">{{ trans('page.disclaimer') }}&nbsp;<span style="color: red">{{ trans('page.disclaimer2') }}</span><br /><br />{!! trans('main.proceed') !!}</p>
                            <button type="submit" class="btn btn-default bg-blue" style="color: white">{{ trans('panel.send') }}</button>
